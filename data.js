const newsData = [
  {
    ...
    "tech": {
      "summary": [
        "Apple is reportedly preparing a refreshed iPad Pro and MacBook Pro lineup for early next year.",
        "Bending Spoons surges 40% on its Nasdaq debut, defying the broader software-as-a-service market slump.",
        "WhatsApp's new username feature raises concerns over identity theft and impersonation vulnerabilities.",
        "Apple's Hide My Email service suffers a critical bug exposing real user email addresses to third parties."
      ],
      "trendAnalysis": "The technology sector is displaying strong resilience, characterized by major IPO successes like Bending Spoons and highly anticipated product refreshes from Apple. However, security and privacy concerns are escalating, with major vulnerabilities exposed in core messaging and email masking infrastructures, prompting calls for more robust identity verification."
    },
    "stocks": {
      "summary": [
        "Ultra Clean Holdings surges over 500%, powered by robust demand in the global semiconductor market.",
        "Comcast's announcement of a corporate split triggers renewed investor interest in Comcast stock.",
        "FactSet deepens integration with Google's agentic AI tools to enhance data retrieval speeds.",
        "Markets navigate headwinds as a major former retail giant closes over 1,000 physical storefronts."
      ],
      "trendAnalysis": "Equities are exhibiting bifurcation, with high-growth technology and semiconductor hardware suppliers continuing to lead the market, while traditional retail giants face severe consolidation. Strategic corporate restructurings, such as Comcast's split and FactSet's agentic AI implementations, demonstrate a focus on unlocking shareholder value amid transition."
    },
    "crypto": {
      "summary": [
        "Robinhood launches its public blockchain and extends cryptocurrency trading capabilities to the UK.",
        "Venice AI becomes a unicorn following a $65 million Series A funding round focusing on privacy-first AI.",
        "The Ethereum Foundation outlines institutional policy frameworks to support state-level blockchain use cases.",
        "Bitcoin struggles near the $60,000 mark as analysts warn of a potential bull trap after a weak June."
      ],
      "trendAnalysis": "The digital asset landscape is seeing accelerated institutional infrastructure expansion, highlighted by Robinhood's public blockchain rollout and the Ethereum Foundation's policy guides for state-level integrations. Concurrently, privacy-focused AI startups are achieving massive valuations, though spot token prices remain highly sensitive to macro inflation expectations and near-term market structure risks."
    }
  },
  {
    "date": "2026-06-17",
